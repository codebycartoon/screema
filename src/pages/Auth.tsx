...
import { Film, Mail, Lock, User, Eye, EyeOff, Loader2, Phone } from 'lucide-react';
...
const phoneSchema = z.string().regex(/^[0-9]{10,15}$/, 'Please enter a valid phone number (10-15 digits)');
...
const Auth = () => {
  ...
  const validateForm = () => {
    const newErrors: { email?: string; password?: string; confirmPassword?: string; name?: string; phone?: string } = {};
        ...
        <div className="relative z-10 w-full max-w-md px-4">
          ...
          <div className="glass rounded-2xl p-8 border border-border/50">
            ...
            <p className="text-muted-foreground text-center mb-6">
              {isLogin ? 'Sign in to access your bookings' : 'Join SCREEMA for the best cinema experience'}
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" variant="cinema" className="w-full" disabled={isLoading}>
                {isLoading ? (
                  <>
